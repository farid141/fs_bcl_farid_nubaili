...
<form class="row g-3" action="{{ route('pengiriman.update', $pengiriman->id) }}" method="POST">
    @method('PUT')
    @csrf
    <div class="mb-3">
        ...
        <select class="form-select" name="id_armada" id="armada">
            ...
            @if (old('id_armada', $pengiriman->id_armada) === $armada->id)
    ...
    <div class="form-floating mb-1">
        <input type="text" class="form-control @error ('loc_asal') is-invalid @enderror" id="loc_asal" name="loc_asal"
            value="{{ old('loc_asal', $pengiriman->loc_asal) }}">
    ...
    <div class="form-floating mb-1">
        <input type="text" class="form-control @error ('loc_tujuan') is-invalid @enderror" id="loc_tujuan"
            name="loc_tujuan" value="{{ old('loc_tujuan', $pengiriman->loc_tujuan) }}">
    ...
    <div class="form-floating mb-1">
        <input name="tanggal_kirim" id="tanggal_kirim" type="text"
    ...
    <button type="submit" class="btn btn-secondary"><i class="bi bi-pencil"></i> Edit pengiriman</button>
</form>
@endsection